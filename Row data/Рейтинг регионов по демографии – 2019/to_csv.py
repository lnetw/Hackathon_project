import pandas as pd
str_res1 = 'Прирост (+), убыль (-) населения за 2016-2018 гг., %'
str_res2 = 'Численность населения на 1 января 2019 г., тыс. чел.'
str_res3 = 'Естественный прирост (+), убыль (-) населения за 2016-2018 гг., тыс. чел.'
str_res4 = 'Миграционный прирост (+), убыль (-) населения за 2016-2018 гг., тыс. чел.'
